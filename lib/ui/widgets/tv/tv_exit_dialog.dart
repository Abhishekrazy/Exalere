  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        ...
        // Prevent instant close from the double-back dispatch that opened the dialog
        if (now.difference(_openedTime).inMilliseconds < 450 &&
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Action Row: Exit Button (autofocused)
                Row(
