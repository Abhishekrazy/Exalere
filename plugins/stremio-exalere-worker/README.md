# Exalere Stream Resolver Worker (Stremio Addon Protocol v1)

This is a standalone, open-source stream resolver microservice compatible with the **Stremio Addon Protocol v1** and **Exalere**.
...
2. Go to **Settings** -> **Stream Add-ons & Plugins**.
3. Tap **Add Plugin** (or **Add Add-on by URL** on TV).
...
- Return an array of stream objects following the Stremio Addon Protocol:
  ```json
  {
    "name": "Server Name\n1080p",
